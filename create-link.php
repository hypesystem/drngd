...
if(!isset($_GET['url']) || $_GET['url'] == "" || $_GET['url'] == "http://url") {
    ...
    if(isset($match)) {
        ...
        echo 'To track and view statistics for your link, see <a href="http://drng.dk/!stats/'.base_convert($get['id'],10,36).'">http://drng.dk/!stats/'.base_convert($get['id'],10,36).'</a> (<a href="#" id="copy-link">copy</a>)';
