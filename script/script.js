    ...
    $("input[type=submit]").click(function() {
        ...
        $.getJSON("create-link.php", { url: $("input[name=url]").attr('value') }, function(createData) {
            if(createData.success) {
                $("#output").html('<span class="green">Success!</span> Your short link is: <a href="'+createData.link.link+'" target="_blank">drng.dk/'+createData.link.id+'</a> (<a href="#" id="copy-link">click here to copy</a>)<br />'+
